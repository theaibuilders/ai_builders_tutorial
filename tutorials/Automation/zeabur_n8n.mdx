# Self-Host n8n on Zeabur for $5/Month

In this tutorial, you'll learn how to deploy a self-hosted n8n instance on [Zeabur](https://zeabur.com), a cloud platform that simplifies the deployment process. We'll use a pre-built template to get you up and running in minutes, all for about **$5 per month**.
...
1. Go to the [Zeabur](https://zeabur.com) and sign up for a new account.
2. Connect your GitHub account to Zeabur. This is how Zeabur will deploy your n8n instance.
![Zeabur1](/public/products/zeabur/zeabur1.png)

## One-Click Deployment

Zeabur provides a one-click template to deploy n8n.

1. Go to the [n8n template on Zeabur](https://zeabur.com/templates/JP88UN).
![Zeabur2](/public/products/zeabur/zeabur2.png)
...
![Zeabur3](/public/products/zeabur/zeabur3.png)
3.  Then, you'll see the n8n dashboard, ready for you to create workflows.
![Zeabur4](/public/products/zeabur/zeabur4.png)
...
1. Visit the AI Builders Zeabur perk page: [https://theaibuilders.org/zeabur](https://theaibuilders.org/zeabur).
