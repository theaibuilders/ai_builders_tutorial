...
In this tutorial, you'll learn how to deploy a self-hosted n8n instance on [Zeabur](https://zeabur.com/?utm_source=aibuilders&utm_medium=aibuilders&utm_campaign=aibuilders), a cloud platform that simplifies the deployment process. We'll use a pre-built template to get you up and running in minutes, all for about **$5 per month**.
...
1. Go to the [Zeabur](https://zeabur.com/?utm_source=aibuilders&utm_medium=aibuilders&utm_campaign=aibuilders ) and sign up for a new account.
...
Check out [Zeabur](https://zeabur.com/?utm_source=aibuilders&utm_medium=aibuilders&utm_campaign=aibuilders) today and start automating your workflows with n8n!
