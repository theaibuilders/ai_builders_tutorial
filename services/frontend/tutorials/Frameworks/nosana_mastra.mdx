...
3. Go to the **Deploy** page
4. Select **GPT-OSS 20B** from the available model templates
5. Choose your preferred GPU configuration (recommended: NVIDIA RTX 4090 or higher)
6. Click **Deploy** and wait for the model to be provisioned (usually takes 2-5 minutes)
7. Once deployed, copy the **API endpoint URL** - it will look like:
   ```
